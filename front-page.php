...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Innovative solutions at your disposal</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">We take pride in continous research and development for ever better solutions</h2>
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="assets/img/mobile-guys.png" class="img-fluid" alt="">
        </div>
      </div>
    </div>
  </section> -->
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h3>EMP Services mission</h3>
              <h2>Our mission is provide a center of excellence in Software Development for institutional clients and
                the general public</h2>
              <p>
                In the world of today, organizations are expected to take advantage of software to Editorister internal
                functions and develop efficient services. Technology itself is changing at a rapid pace. More than ever
                before, the importance of software development keep rising and there is need for establishing sound
                parnerships with development companies.
              </p>
              <div class="text-center text-lg-start">
                <a href="#"
    ...
    <section id="values" class="values">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h2>Our Values</h2>
          <p> Values that shape & inspire our team</p>
        </header>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gy-4">
          <div class="col-lg-3 col-md-6">
            <div class="count-box" style="color: #949393;">
              <i class="bi bi-emoji-smile" style="color: #949393;"></i>
              <div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="count-box" style="color: #949393;">
              <i class="bi bi-journal-richtext" style="color: #949393;"></i>
              <div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="count-box">
              <i class="bi bi-headset" style="color: #949393;"></i>
              <div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="count-box">
              <i class="bi bi-people" style="color: #949393;"></i>
              <div>
    ...
    <!-- <section id="clients" class="clients">
      <div class="container" data-aos="fade-up">
        <header class="section-header">
          ...
          <p>Areas of dedicated expertise</p>
        </header>
            ...
            <div class="row gy-4">
              ...
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Call Us</h3>
                  <p>+254 123456789<br>+1 6678 254445 41</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Email Us</h3>
                  <p>info@empservices.co.ke<br>contact@empservices.co.ke</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
  ...
  <footer id="footer" class="footer">
        ...
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            <a href="index.html" class="logo d-flex align-items-center">
              ...
              <span>EMP Services Ltd</span>
            </a>
            <p>Supporting you at the fronteer of technology race</p>
          ...
          <div class="col-lg-2 col-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="bi bi-chevron-right"></i> <a href="https://empservices.co.ke">Home</a></li>
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            ...
            <p>
              God Kite <br>
              Bar B, 1650<br>
              Kisumu West, Kenya <br><br>
              <!-- <strong>Phone:</strong> +254 123456789<br> -->
              <strong>Email:</strong> info@empservices.co.ke<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>CORPDESK</span></strong>
      </div>
      <div class="credits">
        <!-- All the links in the footer should remain intact. -->
        <!-- You can delete the links only if you purchased the pro version. -->
        <!-- Licensing information: https://empservices.co.ke/license/ -->
        <!-- Purchase the pro version with working PHP/AJAX contact form: https://empservices.co.ke/EMP Services Ltd-bootstrap-startup-template/ -->
        <!-- Powered by <a href="https://empservices.co.ke/">BootstrapMade</a> -->
      </div>
    </div>
  </footer><!-- End Footer -->
